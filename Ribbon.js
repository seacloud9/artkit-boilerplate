...
Ribbon.prototype.getRandPt = function () {
  ...
  //return THREE.ribbonGroup && THREE.ribbonGroup.ribbonTarget ? THREE.ribbonGroup.ribbonTarget.clone().add(ATUtil.getRandVec3D(-THREE.ribbonGroup.ribbonSeparation, THREE.ribbonGroup.ribbonSeparation)): new THREE.Vector3(0,0,0)
}
